...
import static com.studio.foodexpiry.FoodList.sqLiteHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText edtName,edtType,edtExpiry,edtExpected;
    ...
    private void init(){
        ...
        edtType = (EditText) findViewById(R.id.etType);
        edtExpiry = (EditText) findViewById(R.id.etExpiryDate);
        edtExpected = (EditText) findViewById(R.id.etExpected);
